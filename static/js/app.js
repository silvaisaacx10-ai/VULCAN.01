...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Configurar navegaçãoo do Wizard
    ...
    // Configurar navegaçãoo entre abas
    ...
    // Carregar estado de autenticaçãoo
    ...
    // Iniciar cronômetro de navegaçãoo (salva a cada 1 minuto)
    ...
    try {
        ...
        try {
            ...
            if(planResp.ok) {
                ...
                const errData = await planResp.json();



                showToast(errData.error || 'Acesso bloqueado pelo administrador.', 'error');
        ...
        showToast('Erro de conexãoo', 'error');
...
// LOGICA DO ONBOARDING / WIZARD (FORMULARIO MULTI-ETAPAS)
...
// SUBMISSAO DO FORMULARIO DE ONBOARDING PARA O BACKEND
...
async function submitOnboardingForm() {
    ...
    try {
        ...
        // Parar animaçãoo e ir para o Dashboard
        ...
        card.innerHTML = `
            ...
            <div class="meal-card-header">
                ...
                <div class="meal-header-macros">
                    ...
                    <span class="badge badge-primary">${calories} kcal</span>
...
function setupTabs() {
    ...
    navItems.forEach(item => {
        ...
        item.addEventListener('click', () => {
            ...
            // Atualizar botões de navegaçãoo
